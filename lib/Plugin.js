...
module.exports = class SpritesmithPlugin {
  ...
  _compile() {
    ...
    return _asyncToGenerator(function* () {
      ...
      const generateSpriteName = _this.options.apiOptions.generateSpriteName;
      const sourceImages = Object.values((yield promiseCall(glob, src.glob, _objectSpread({}, src.globOptions, {
        cwd: src.cwd
